...
(function () {
  ...
  /* ---- gas: header chip links to /gas (M12, 2026-07-08) ----------------
     The per-page 5-station expander + grade switch was removed site-wide; the
     gas tile is now a plain <a href="/gas">, so there is no panel JS to bind. */
