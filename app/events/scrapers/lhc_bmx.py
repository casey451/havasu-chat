...
Provenance & rollout (WS12): this is a **re-pullable structured feed**, but it
is deliberately NOT in the auto-approve registry — like every WS12 connector it
lands PENDING in the review queue (training wheels) until Casey has approved a
clean week (see ``app/contrib/approval_service.py``).

Salvaged from closed PR #302 (feat/youth-calendar, 2026-06-12). Endpoint
re-verified live 2026-07-09; the item schema below is unchanged. Endpoint shape
(both arrays share one item schema)::
