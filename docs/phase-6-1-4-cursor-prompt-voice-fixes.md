...
|----|--------|----------------|
| `t1-HOURS-03` | **ACCEPT** + MODIFY | `tier1_templates.py` — conditional **"is open"** vs **"'s open"** using a helper (e.g. `_short_provider_display_name`); rule: **> 2 words OR > 18 chars** → `"is open"`; else contraction allowed. Re-verify `t1-HOURS-01`, `t1-HOURS-02`, `t1-HOURS-03` strings. |
