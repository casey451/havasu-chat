...
One place to find Markdown for **prod dry-run** and related decisions.
...
- **`ddf7b65`** — docs: fix 2 narrative (`river_scene_backfill_fix2.md`, since removed from tree — see `git show ddf7b65`), this index, sentinel-id retention note on runbook + quick reference.
