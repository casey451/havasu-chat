...
| [`river_scene_dryrun_quick_reference.md`](river_scene_dryrun_quick_reference.md) | One-screen cheat sheet during the run (commands, halt table, partition, sentinels). |
