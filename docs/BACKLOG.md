...
- [ ] **C — Documentation depth where code is complex.**
  - [ ] **Component docs growth** (ongoing). Tier2 stack, contrib/River Scene, admin. **Added so far:** `unified_router.md`; `tier2_handler.md` (Slice 25, `7c339e0`); `tier2_formatter.md` (Slice 27, `486dc11`); `tier3_handler.md` (Slice 33, `66636a6`); `tier2_parser.md` (Slice 34, `fbe8ae6`); `intent_classifier.md` + `hint_extractor.md` + `llm_router.md` (Slice 32, `da68612`); `river_scene.md` (Slice 36, `d86c7f6`); `tier1_handler.md` (Slice 35, `6910a24`); `approval_service.md` (Slice 37, `c919b9c`); `llm_messages.md` (Slice 38, `dbfd029`); `admin_auth.md` + `admin_router.md` (Slice 40, `2d1c6e1`); `mention_scanner.md` (Slice 42, `4ec2787`); `event_quality.md` (Slice 43, `ae40445`). Audit + remaining priorities tracked in `relay/component_doc_audit.md`.
