...
- [ ] **C — Documentation depth where code is complex.**
  - [ ] **Component docs growth** (ongoing). Tier2 stack, contrib/River Scene, admin. **Added so far:** `unified_router.md`; `tier2_handler.md` (Slice 25, `7c339e0`); `tier2_formatter.md` (Slice 27, `486dc11`); `tier3_handler.md` (Slice 33, `66636a6`); `tier2_parser.md` (Slice 34, `fbe8ae6`). Audit + remaining priorities tracked in `relay/component_doc_audit.md`.
